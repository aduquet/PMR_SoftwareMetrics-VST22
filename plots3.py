...
df = pd.read_csv('AUC-comparison.csv', index_col=0)


metrics = ['NF-PF [11]','GK [11]','RWK [11]','SM']
...
colors = ['#005ecd', '#aaad87', '#dd9343', '#980f00', '#7b8ce0']
#,
...
plt.legend(metrics,loc='upper center', bbox_to_anchor=(1.12,1),
